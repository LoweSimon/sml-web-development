...
<section class="thin-hero relative lg:max-h-[36rem] max-h-72  h-full w-full">
    ...
    <div class="container relative lg:max-h-[36rem] max-h-80 w-full h-screen flex justify-center items-center">
