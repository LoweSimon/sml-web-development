...
<!-- <div class="service-container flex justify-between w-full absolute top-44 container">
    ...
    <div class="ecomm flex xl:w-[31rem] xl:h-[40rem] md:w-96 md:h-[35rem] justify-center items-center">
        <img src="/wp-content/uploads/2024/04/bnspyrd_stock_postal_steampunk_ochre_png_by_bnspyrd_d4n74ya.png" alt="" class="absolute xl:w-[31rem] xl:h-[40rem] md:w-96 md:h-[35rem] opacity-80">
        <div class="services-content flex flex-col absolute top-14 h-full xl:w-[25rem] lg:w-80">
    ...
    <div class="non-ecomm flex xl:w-[31rem] xl:h-[40rem] md:w-96 md:h-[35rem] justify-center items-center">
        <img src="/wp-content/uploads/2024/04/bnspyrd_stock_postal_steampunk_ochre_png_by_bnspyrd_d4n74ya.png" alt="" class="absolute xl:w-[31rem] xl:h-[40rem] md:w-96 md:h-[35rem] opacity-80">
        <div class="services-content flex flex-col absolute top-14 h-full xl:w-[25rem] lg:w-80">
...
<div class="swiper mySwiper left-0 top-40 xl:w-[31rem] xl:h-[40rem] md:w-96 md:h-[35rem]">
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide non-ecomm flex xl:w-[31rem] xl:h-[40rem] md:w-96 md:h-[35rem] justify-center items-center"><img src="/wp-content/uploads/2024/04/bnspyrd_stock_postal_steampunk_ochre_png_by_bnspyrd_d4n74ya.png" alt="" class="absolute xl:w-[31rem] xl:h-[40rem] md:w-96 md:h-[35rem] opacity-80">
        <div class="services-content flex flex-col absolute top-14 h-full xl:w-[25rem] lg:w-80">
            <h3 class="flex justify-center items-center underline"><?php echo $non_ecommService; ?></h3>
            <div class="absolute top-16">
                <?php echo $non_ecommDescription; ?>
